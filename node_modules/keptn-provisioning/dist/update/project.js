...
async function updateProject(project, auth) {
    ...
    if ((await (0, requests_1.sendRequest)(controlPlane, auth, 'getProjectByName')).code === 404) {
        await (0, requests_1.sendRequest)(controlPlane, auth, 'createNewProject', (0, body_1.generateProjectBody)(project, (0, js_base64_1.encode)((0, fs_1.readFileSync)(project.shipyardPath, 'utf8'))));
    }
    else {
